...
$Id: sc_servo_api.h 1.26 2012/02/14 17:25:56PST Kenneth Ho (kho) Exp  $
...
#define k_DEFAULT_SERVO_PHASE_MODE        (k_PTP_PHASE_MODE_STANDARD)
...
typedef enum
{
  ...
  e_PTP_MODE_HIGH_JITTER_ACCESS = (5)    /* High jitter on access mode  */
