...
FILE NAME    : $Source: sc_config_bcom_ka.h $

AUTHOR       : Daniel Brown

DESCRIPTION  : 

This file is for the Broadcom Katana project. Broadcom Katana
Uses the following channels:
  * PTP                 e_SC_CHAN_TYPE_PTP
  * Redundancy          e_SC_CHAN_TYPE_REDUNDANT
  * Frequency only      e_SC_CHAN_TYPE_FREQ_ONLY
...
$Id: sc_config_bcom_ka.h 1.3 2011/10/11 14:49:54PDT German Alvarez (galvarez) Exp  $
...
#define SC_TOTAL_CHANNELS  3  /* maximum number of channels - sum of channels below */
...
#define SC_RED_CHANNELS    1  /* maximum number of Redundancy channels */
#define SC_FREQ_CHANNELS   1  /* maximum number of Frequency only channels */
