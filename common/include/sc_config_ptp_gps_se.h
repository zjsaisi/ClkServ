...
$Id: sc_config_ptp_gps_se.h 1.4 2011/10/06 16:24:09PDT Kenneth Ho (kho) Exp  $
...
#define SC_TOTAL_CHANNELS  7  /* maximum number of channels - sum of channels below */
#define SC_PTP_CHANNELS    1  /* maximum number of PTP channels */
#define SC_GPS_CHANNELS    4  /* maximum number of GPS channels */
