...
$Id: sc_config_servo.h 1.4 2011/10/11 14:29:44PDT German Alvarez (galvarez) Exp  $
...
#define SC_TOTAL_CHANNELS  6  /* maximum number of channels - sum of channels below */
#define SC_PTP_CHANNELS    1  /* maximum number of PTP channels */
#define SC_GPS_CHANNELS    1  /* maximum number of GPS channels */
#define SC_SYNCE_CHANNELS  2  /* maximum number of Synchronous Ethernet channels */
#define SC_SPAN_CHANNELS   2  /* maximum number of Traditional Sync channels */
#define SC_RED_CHANNELS    1  /* maximum number of Traditional Redundancy channels */
