...
// All rights reserved.
//
// Filename  GN_GPS_GNB_Patch_502.c
//
// $Header: GNS/GN_GPS_GNB_Patch_502.c 1.2 2011/04/01 15:06:11PDT Daniel Brown (dbrown) Exp  $
// $Locker:  $
//*****************************************************************************
...
#include "Baseband_Patch_502.c"        // The baseband patch code to upload


//*****************************************************************************
//  Get the the patch checksum for GNS7560 ROM5 v502 baseband.

U2 GN_GetPatchCheckSum_502()
{
...
//*****************************************************************************
// Upload the next set of patch code to a GNS7560 ROM5 v502 baseband.
